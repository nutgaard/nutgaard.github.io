...
var _nutgaard$nutgaardgithubio$Model$initialModel = {
	selectedTab: 0,
	repos: {ctor: '[]'}
};
var _nutgaard$nutgaardgithubio$Model$GithubRepo = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {has_pages: a, name: b, description: c, watchers_count: d, fork: e, forks_count: f, open_issues_count: g, stargazers_count: h, pushed_at: i};
	});
var _nutgaard$nutgaardgithubio$Model$Model = F2(
	function (a, b) {
		return {selectedTab: a, repos: b};
	});

var _nutgaard$nutgaardgithubio$Msg$NewExtra = function (a) {
	return {ctor: 'NewExtra', _0: a};
};
var _nutgaard$nutgaardgithubio$Msg$ChangeTab = F2(
	function (a, b) {
		return {ctor: 'ChangeTab', _0: a, _1: b};
	});
var _nutgaard$nutgaardgithubio$Msg$Inc = {ctor: 'Inc'};

var _nutgaard$nutgaardgithubio$About$view = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('This is where I would put the about section...'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _nutgaard$nutgaardgithubio$About$onEnter = A2(
	_elm_lang$core$Task$perform,
	_elm_lang$core$Basics$identity,
	_elm_lang$core$Task$succeed(
		_nutgaard$nutgaardgithubio$Msg$NewExtra(
...
var _nutgaard$nutgaardgithubio$RepoView$single = function (repo) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('github__repo'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								...
								_elm_lang$core$Basics$toString(repo.has_pages),
								A2(_elm_lang$core$Basics_ops['++'], ' ', repo.pushed_at))),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _nutgaard$nutgaardgithubio$RepoView$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('grid github__repos grid--small-1 grid--medium-2 grid--large-3'),
			_1: {ctor: '[]'}
		},
		A2(_elm_lang$core$List$map, _nutgaard$nutgaardgithubio$RepoView$single, model.repos));
};
var _nutgaard$nutgaardgithubio$RepoView$onEnter = A2(
	_elm_lang$core$Task$perform,
	_elm_lang$core$Basics$identity,
	_elm_lang$core$Task$succeed(
		_nutgaard$nutgaardgithubio$Msg$NewExtra(
...
var _nutgaard$nutgaardgithubio$Statistics$lastUpdated = function (model) {
	var lastUpdatedRepo = function () {
		var _p0 = A2(
			_elm_lang$core$Array$get,
			0,
			_elm_lang$core$Array$fromList(model.repos));
		if (_p0.ctor === 'Nothing') {
			return 'Found no updated repos';
		} else {
			return _p0._0.name;
		}
	}();
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Latest update: '),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(lastUpdatedRepo),
				_1: {ctor: '[]'}
			}
		});
};
var _nutgaard$nutgaardgithubio$Statistics$nofRepos = function (model) {
	return A2(
		_elm_lang$html$Html$p,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Number of repositories: '),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(
						_elm_lang$core$List$length(model.repos))),
				_1: {ctor: '[]'}
			}
		});
};
var _nutgaard$nutgaardgithubio$Statistics$findMax = F3(
	function (extract, a, b) {
		return (_elm_lang$core$Native_Utils.cmp(
			extract(a),
			extract(b)) > 0) ? a : b;
	});
var _nutgaard$nutgaardgithubio$Statistics$maxBy = F2(
	function (list, extract) {
		var _p1 = A2(
			_elm_lang$core$Array$get,
			0,
		...
		if (_p1.ctor === 'Nothing') {
			...
			return _elm_lang$core$Maybe$Just(
				A3(
					_elm_lang$core$List$foldr,
					_nutgaard$nutgaardgithubio$Statistics$findMax(extract),
					_p1._0,
					list));
		}
	});
var _nutgaard$nutgaardgithubio$Statistics$getMaxBySomething = F3(
	function (repos, maxByExtract, txt) {
		var maxed = A2(_nutgaard$nutgaardgithubio$Statistics$maxBy, repos, maxByExtract);
		var name = function () {
			var _p2 = maxed;
			if (_p2.ctor === 'Nothing') {
				return 'Not found';
...
var _nutgaard$nutgaardgithubio$Statistics$mostWatchers = function (model) {
	return A3(
		_nutgaard$nutgaardgithubio$Statistics$getMaxBySomething,
		model.repos,
		function (repo) {
...
var _nutgaard$nutgaardgithubio$Statistics$mostForks = function (model) {
	return A3(
		_nutgaard$nutgaardgithubio$Statistics$getMaxBySomething,
		A2(
...
var _nutgaard$nutgaardgithubio$Statistics$mostIssues = function (model) {
	return A3(
		_nutgaard$nutgaardgithubio$Statistics$getMaxBySomething,
		model.repos,
		function (repo) {
...
var _nutgaard$nutgaardgithubio$Statistics$mostStars = function (model) {
	return A3(
		_nutgaard$nutgaardgithubio$Statistics$getMaxBySomething,
		model.repos,
		function (repo) {
...
var _nutgaard$nutgaardgithubio$Statistics$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('grid github__statistics grid--small-1 grid--medium-2 grid--large-3'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _nutgaard$nutgaardgithubio$Statistics$nofRepos(model),
			_1: {
				ctor: '::',
				_0: _nutgaard$nutgaardgithubio$Statistics$lastUpdated(model),
				_1: {
					ctor: '::',
					_0: _nutgaard$nutgaardgithubio$Statistics$mostWatchers(model),
					_1: {
						ctor: '::',
						_0: _nutgaard$nutgaardgithubio$Statistics$mostForks(model),
						_1: {
							ctor: '::',
							_0: _nutgaard$nutgaardgithubio$Statistics$mostIssues(model),
							_1: {
								ctor: '::',
								_0: _nutgaard$nutgaardgithubio$Statistics$mostStars(model),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _nutgaard$nutgaardgithubio$Repos$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Repos'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _nutgaard$nutgaardgithubio$Statistics$view(model),
				_1: {
					ctor: '::',
					_0: _nutgaard$nutgaardgithubio$RepoView$view(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _nutgaard$nutgaardgithubio$Repos$repoDecoder = A3(
						...
						A4(
							...
							A3(
								...
								A3(
									...
									'has_pages',
									_elm_lang$core$Json_Decode$bool,
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_nutgaard$nutgaardgithubio$Model$GithubRepo))))))))));
var _nutgaard$nutgaardgithubio$Repos$responseDecoder = _elm_lang$core$Json_Decode$list(_nutgaard$nutgaardgithubio$Repos$repoDecoder);
var _nutgaard$nutgaardgithubio$Repos$onEnter = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(model.repos),
		0) ? A2(
		_elm_lang$http$Http$send,
		_nutgaard$nutgaardgithubio$Msg$NewExtra,
		A2(_elm_lang$http$Http$get, 'https://api.github.com/users/nutgaard/repos?per_page=100', _nutgaard$nutgaardgithubio$Repos$responseDecoder)) : _elm_lang$core$Platform_Cmd$none;
};
var _nutgaard$nutgaardgithubio$Repos$repoComparator = F2(
	function (a, b) {
		var bPages = b.has_pages;
		var aPages = a.has_pages;
		var bDate = A2(
			_elm_lang$core$Result$withDefault,
			_elm_lang$core$Date$fromTime(0),
			_elm_lang$core$Date$fromString(b.pushed_at));
		var aDate = A2(
			_elm_lang$core$Result$withDefault,
			_elm_lang$core$Date$fromTime(0),
			_elm_lang$core$Date$fromString(a.pushed_at));
		return _elm_lang$core$Native_Utils.eq(aPages, bPages) ? (A3(_rluiten$elm_date_extra$Date_Extra_Compare$is, _rluiten$elm_date_extra$Date_Extra_Compare$After, aDate, bDate) ? _elm_lang$core$Basics$LT : _elm_lang$core$Basics$GT) : (aPages ? _elm_lang$core$Basics$LT : _elm_lang$core$Basics$GT);
	});
var _nutgaard$nutgaardgithubio$Repos$sortRepos = function (repos) {
	return A2(_elm_lang$core$List$sortWith, _nutgaard$nutgaardgithubio$Repos$repoComparator, repos);
};

var _nutgaard$nutgaardgithubio$Tabs$getContent = F2(
	function (model, contentList) {
		var _p0 = A2(
			_elm_lang$core$Array$get,
			model.selectedTab,
			_elm_lang$core$Array$fromList(contentList));
		if (_p0.ctor === 'Just') {
			return A2(
				_elm_lang$html$Html$div,
				{
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Could not find page'),
					_1: {ctor: '[]'}
				});
		}
	});
var _nutgaard$nutgaardgithubio$Tabs$toTab = F3(
	function (selected, index, tabConfig) {
		var className = _elm_lang$core$Native_Utils.eq(selected, index) ? 'tabs__tabbutton tabs__tabbutton--isactive' : 'tabs__tabbutton';
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						A2(_nutgaard$nutgaardgithubio$Msg$ChangeTab, index, tabConfig.onEnter)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(tabConfig.name),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	});
var _nutgaard$nutgaardgithubio$Tabs$view = F2(
	function (model, tabConfig) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			A2(
				...
				A2(
					...
					_nutgaard$nutgaardgithubio$Tabs$toTab(model.selectedTab),
					tabConfig),
				{
					ctor: '::',
					_0: A2(_nutgaard$nutgaardgithubio$Tabs$getContent, model, tabConfig),
					_1: {ctor: '[]'}
				}));
	});
var _nutgaard$nutgaardgithubio$Tabs$TabConfig = F3(
	function (a, b, c) {
		return {name: a, content: b, onEnter: c};
	});

var _nutgaard$nutgaardgithubio$ApplicationMain$tabConfig = function (model) {
	return {
		ctor: '::',
		_0: {
			name: 'Github repos',
			content: _nutgaard$nutgaardgithubio$Repos$view,
			onEnter: _nutgaard$nutgaardgithubio$Repos$onEnter(model)
		},
		_1: {
			ctor: '::',
			_0: {
			...
			_1: {
				ctor: '::',
				_0: {name: 'About', content: _nutgaard$nutgaardgithubio$About$view, onEnter: _nutgaard$nutgaardgithubio$About$onEnter},
				_1: {ctor: '[]'}
			}
		}
	};
};
var _nutgaard$nutgaardgithubio$ApplicationMain$view = function (model) {
	return A2(
		_elm_lang$html$Html$main_,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('application__main'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_nutgaard$nutgaardgithubio$Tabs$view,
				model,
				_nutgaard$nutgaardgithubio$ApplicationMain$tabConfig(model)),
			_1: {ctor: '[]'}
		});
};

var _nutgaard$nutgaardgithubio$Footer$view = A2(
	_elm_lang$html$Html$footer,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('footer dark'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Utgaard'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});

var _nutgaard$nutgaardgithubio$Header$view = A2(
	_elm_lang$html$Html$header,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('header dark'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _nutgaard$nutgaardgithubio$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Inc':
				...
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								repos: _nutgaard$nutgaardgithubio$Repos$sortRepos(_p0._0._0)
							}),
...
var _nutgaard$nutgaardgithubio$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _nutgaard$nutgaardgithubio$Header$view,
			_1: {
				ctor: '::',
				_0: _nutgaard$nutgaardgithubio$ApplicationMain$view(model),
				_1: {
					ctor: '::',
					_0: _nutgaard$nutgaardgithubio$Footer$view,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _nutgaard$nutgaardgithubio$Main$init = {
	ctor: '_Tuple2',
	_0: _nutgaard$nutgaardgithubio$Model$initialModel,
	_1: _nutgaard$nutgaardgithubio$Repos$onEnter(_nutgaard$nutgaardgithubio$Model$initialModel)
};
var _nutgaard$nutgaardgithubio$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _nutgaard$nutgaardgithubio$Main$main = _elm_lang$html$Html$program(
	{view: _nutgaard$nutgaardgithubio$View$view, update: _nutgaard$nutgaardgithubio$Update$update, init: _nutgaard$nutgaardgithubio$Main$init, subscriptions: _nutgaard$nutgaardgithubio$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _nutgaard$nutgaardgithubio$Main$main !== 'undefined') {
    _nutgaard$nutgaardgithubio$Main$main(Elm['Main'], 'Main', undefined);
}
